...
def getvals():
    ...
    print(f"{namevalue.get(), gendervalue.get(), phonevalue.get(), emergencyvalue.get(), foodservicevalue.get()}\n")
    with open("records.txt", "a") as f:
        f.write(f"{namevalue.get(), gendervalue.get(), phonevalue.get(), emergencyvalue.get(), foodservicevalue.get()}\n") 
root = Tk()
